...
void mosca_display(void)
{
	...
	glPopMatrix();
	glPushMatrix();
	glTranslatef(andar_mosca-70, 0, 0);
	mosca_asa2();
	glPopMatrix();	
	glPushMatrix();
	glTranslatef(andar_mosca-70, -1, 0);
	mosca_desenhaCorpo();
	glPopMatrix();	
	glPushMatrix();
	glTranslatef(andar_mosca-72, +13, 0);
	mosca_primeiroOlho();
	glPopMatrix();
	glPushMatrix();
	glTranslatef(andar_mosca-68, +13, 0);
	mosca_segundoOlho();
	glPopMatrix();
	glPushMatrix();
	glTranslatef(andar_mosca-65, -15, 0);
	mosca_desenhaPe1();
	glPopMatrix();
	glPushMatrix();
	glTranslatef(andar_mosca-68, -18, 0);
	mosca_desenhaPe1();
	glPopMatrix();		
	glPushMatrix();
	glTranslatef(andar_mosca-72, -18, 0);
	mosca_desenhaPe2();
	glPopMatrix();
	glPushMatrix();
	glTranslatef(andar_mosca-75, -15, 0);
	mosca_desenhaPe2();
	glPopMatrix();
	glPushMatrix();
	glTranslatef(andar_mosca-78, -4, 0);
	mosca_desenhaMao1();
	glPopMatrix();
	glPushMatrix();
	glTranslatef(andar_mosca-62, -4, 0);
	mosca_desenhaMao2();
	glPopMatrix();	
