...
void geraTexto(float x, float y, string t, void* fonte )
{
  glRasterPos2f(x,y);
  for(int i=0; i < t.length(); i++)
  {
    glutBitmapCharacter(fonte, t[i]);
  }
}
...
//texto
aux = toString(ponto);
geraTexto(160,150,"PONTUACAO:", GLUT_BITMAP_TIMES_ROMAN_24);
geraTexto(230,150,aux, GLUT_BITMAP_TIMES_ROMAN_24);
...
void idle(){
  ...
  if(pause == false)
  {
    currentTime  =  tempoInicial - timePause;
